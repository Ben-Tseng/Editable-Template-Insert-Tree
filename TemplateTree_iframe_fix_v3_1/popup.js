...
function ttEditTemplate(tplId) {
    ...
    const createOptionItem = (index) => {
        ...
        deleteOptBtn.style.background = "#111";
        deleteOptBtn.style.color = "#fff";
        ...
        optNameInput.style.marginBottom = "6px";
    ...
    addOptBtn.textContent = "+ Add Option";
        addOptBtn.style.background = "#111";
        addOptBtn.style.color = "#fff";
    ...
    saveBtn.style.border = "1px solid #111";
...
function ttDeleteTemplate(tplId) {
    chrome.storage.local.remove(tplId, () => {
